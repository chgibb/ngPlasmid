...
export class TestCase
{
    ...
    public optimiseReferenceCompilerResult()
    {
        ...
        let res = cp.execSync(`node node_modules/.bin/svgo -i ${this.referenceResultPath} -o ${this.referenceResultOptimisedPath} --multipass --enable=sortAttrs --pretty --indent=4`);
    ...
    public optimiseExHTMLToSVGCompilerResult()
    {
        ...
        let res = cp.execSync(`node node_modules/.bin/svgo -i ${this.exHTMLToSVGResultPath} -o ${this.exHTMLToSVGResultOptimisedPath} --multipass --enable=sortAttrs --pretty --indent=4`);
    ...
    public optimiseExPBToSVGCompilerResult()
    {
        ...
        let res = cp.execSync(`node node_modules/.bin/svgo -i ${this.exPBToSVGResultPath} -o ${this.exPBToSVGResultOptimisedPath} --multipass --enable=sortAttrs --pretty --indent=4`);
